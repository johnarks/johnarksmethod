...
You define what "proven" means. For each checkpoint in `.jam/checkpoints.json`, generate test cases that verify behavior **the way a user would experience it**, exercised through code (integration tests) — no browser, no screenshots at this stage.
