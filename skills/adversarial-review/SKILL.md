...
Archive under `.jam/evidence/<checkpoint-id>/adversarial/`: each review round's findings, the fixes applied, test re-run results, and both final approvals. This is the paper trail that the checkpoint's code was held to the standard.
